...
#define VDPP2_REG_OFF_DMSR              (0x0080) // 0x1080
#define VDPP2_REG_OFF_DCI_HIST          (0x00E0) // 0x10E0
#define VDPP2_REG_OFF_ES                (0x0100) // 0x1100
#define VDPP2_REG_OFF_SHARP             (0x0200) // 0x1200
#define VDPP2_REG_OFF_YRGB_HOR_COE      (0x2000)
#define VDPP2_REG_OFF_YRGB_VER_COE      (0x2200)
#define VDPP2_REG_OFF_CBCR_HOR_COE      (0x2400)
#define VDPP2_REG_OFF_CBCR_VER_COE      (0x2600)
#define VDPP2_REG_OFF_ZME_COMMON        (0x2800)

typedef struct vdpp2_com2_reg {
    struct {
        RK_U32 sw_vep_frm_en        : 1;
    } reg0;         // 0x0000

    struct {
        RK_U32 sw_vep_src_fmt           : 2;
        RK_U32 sw_reserved_1            : 2;
        RK_U32 sw_vep_src_yuv_swap      : 2;
        RK_U32 sw_reserved_2            : 2;
        RK_U32 sw_vep_dst_fmt           : 2;
        RK_U32 sw_vep_yuvout_diff_en    : 1;
        RK_U32 sw_reserved_3            : 1;
        RK_U32 sw_vep_dst_yuv_swap      : 2;
        RK_U32 sw_reserved_4            : 2;
        RK_U32 sw_vep_debug_data_en     : 1;
        RK_U32 sw_reserved_5            : 3;
        RK_U32 sw_vep_rst_protect_dis   : 1;
        RK_U32 sys_vep_sreset_p         : 1;
        RK_U32 sw_vep_init_dis          : 1;
        RK_U32 sw_reserved_6            : 1;
        RK_U32 sw_vep_dbmsr_en          : 1;
        RK_U32 sw_dci_en                : 1;
    } reg1;         // 0x0004
    ...
    struct {
        RK_U32 sw_vep_arqos_en      : 1;
        RK_U32 sw_vep_awqos_en      : 1;
        RK_U32 sw_reserved_1        : 2;
        RK_U32 sw_ar_mmu_qos3       : 4;
    } reg3;         // 0x000C

    struct {
        RK_U32 sw_vep_clk_on        : 1;
    ...
    struct {
        RK_U32 sw_vep_frm_done_en       : 1;
        RK_U32 sw_vep_osd_max_en        : 1;
        RK_U32 sw_reserved_1            : 2;
        RK_U32 sw_vep_bus_error_en      : 1;
        RK_U32 sw_vep_timeout_int_en    : 1;
        RK_U32 sw_vep_config_error_en   : 1;
    } reg8;         // 0x0020

    struct {
        RK_U32 sw_vep_frm_done_clr      : 1;
        RK_U32 sw_vep_osd_max_clr       : 1;
        RK_U32 sw_reserved_1            : 2;
        RK_U32 sw_vep_bus_error_clr     : 1;
        RK_U32 sw_vep_timeout_int_clr   : 1;
        RK_U32 sw_vep_config_error_clr  : 1;
    } reg9;        // 0x0024
    ...
    struct {
        RK_U32 sw_vep_src_vir_y_stride      : 16;
    } reg12;         // 0x0030

    struct {
        RK_U32 sw_vep_dst_vir_y_stride      : 16;
        RK_U32 sw_vep_dst_vir_c_stride      : 16;
    } reg13;         // 0x0034

    struct {
        RK_U32 sw_vep_src_pic_width         : 11;
        RK_U32 sw_reserved_1                : 1;
        RK_U32 sw_vep_src_right_redundant   : 4;
        RK_U32 sw_vep_src_pic_height        : 11;
        RK_U32 sw_reserved_2                : 1;
        RK_U32 sw_vep_src_down_redundant    : 3;
    } reg14;         // 0x0038

    struct {
        RK_U32 sw_vep_dst_pic_width         : 11;
        RK_U32 sw_reserved_1                : 1;
        RK_U32 sw_vep_dst_right_redundant   : 4;
        RK_U32 sw_vep_dst_pic_height        : 11;
    } reg15;         // 0x003C

    struct {
        RK_U32 sw_vep_dst_pic_width_c       : 11;
        RK_U32 reserved1                    : 1;
        RK_U32 sw_vep_dst_right_redundant_c : 4;
        RK_U32 sw_vep_dst_pic_height_c      : 11;
    } reg16;         // 0x0040
    ...
    struct {
        RK_U32 sw_vep_timeout_cnt   : 31;
        RK_U32 sw_vep_timeout_en    : 1;
    } reg20;         // 0x0050
    ...
    struct {
        RK_U32 sw_vep_src_addr_y    : 32;
    } reg24;         // 0x0060

    struct {
        RK_U32 sw_vep_src_addr_uv   : 32;
    } reg25;         // 0x0064

    struct {
        RK_U32 sw_vep_dst_addr_y    : 32;
    } reg26;         // 0x0068

    struct {
        RK_U32 sw_vep_dst_addr_uv   : 32;
    } reg27;         // 0x006C
} RegCom2;  // 0x0000 ~ 0x006C, 28 regs

typedef struct vdpp2_hist_reg {
    struct {
    ...
    struct {
        RK_U32 sw_vep_src_pic_width     : 12;
        RK_U32 reserved1                : 4;
        RK_U32 sw_vep_src_pic_height    : 12;
    } reg2;          // 0x00E8
...
} RegHist;  // 0x10E0 -> 0x00F0, 5 regs

typedef struct vdpp2_es_reg {
    struct {
        RK_U32 es_enable         : 1;
    } reg0;          // 0x0100
...
} RegEs;    // 0x1100 ~ 0x117C, 32 regs

typedef struct vdpp2_shp_reg {
    struct {
...
} RegShp;   // 0x1200 ~ 0x14a8, 171 regs

typedef struct vdpp2_reg {
    ...
    RegZme  zme;    /* offset: 0x2000, end: 0x2844, size: 1160(valid)/2120(total) */
} Vdpp2Regs;
