...
{
    MPP_RET ret = MPP_OK;
    hal_vp9_context_t *ctx = (hal_vp9_context_t *)hal;
    ...
    ret = mpp_dev_init(&ctx->dev, VPU_CLIENT_RKVDEC);
    if (ret) {
