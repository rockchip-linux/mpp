...
static struct {
...
} vdpu384b_def_prob_update_info[VDPU384B_DEF_CDF_UPDATE_ARRAY_SIZE] = {
    {
        ...
        .new_data_sz = 64,
        .data = {
            0xc173a0d7, 0x76e1e02e, 0xb019c8a6, 0x48523960,
            0xfcf54494, 0x58c607f1, 0x4c5b184f, 0x80000001,
            0x00000000, 0x00000000, 0x00000000, 0x00000000,
            0x00000000, 0x00000000, 0x00000000, 0x00000000,
        },
    },
    {
        .org_data_off = 330 * 8 * 4,
        .new_data_sz = 64,
        .data = {
            0xc0a5182c, 0x75d18016, 0xb40d6060, 0xf137393d,
            0xa9ef068a, 0xea22d40b, 0xf22e827e, 0x80000000,
            0x00000000, 0x00000000, 0x00000000, 0x00000000,
            0x00000000, 0x00000000, 0x00000000, 0x00000000,
        },
    },
    {
        .org_data_off = 346 * 8 * 4,
        .new_data_sz = 64,
        .data = {
            0x01069b27, 0x96e8c00c, 0x4c0dd857, 0x7a22c525,
            0x16a81083, 0xaa70ad26, 0x43795d65, 0x80000000,
            0x00000000, 0x00000000, 0x00000000, 0x00000000,
            0x00000000, 0x00000000, 0x00000000, 0x00000000,
        },
    },
    {
        .org_data_off = 362 * 8 * 4,
        .new_data_sz = 64,
        .data = {
            0x20006000, 0x0c000800, 0x01000400, 0x00800180,
            0x00300020, 0x00040010, 0x80020006, 0x80000000,
            0x00000000, 0x00000000, 0x00000000, 0x00000000,
            0x00000000, 0x00000000, 0x00000000, 0x00000000,
        },
    },
    {
        .org_data_off = 378 * 8 * 4,
        .new_data_sz = 64,
        .data = {
            0x20006000, 0x0c000800, 0x01000400, 0x00800180,
            0x00300020, 0x00040010, 0x80020006, 0x80000000,
    ...
    {
        .org_data_off = 491 * 8 * 4,
        .new_data_sz = 64,
        .data = {
            0x41b61d2e, 0xe74de045, 0xf02740d6, 0x2d595f68,
            0x5936ad18, 0x6ee6bc13, 0x4bb32457, 0x80000001,
            0x00000000, 0x00000000, 0x00000000, 0x00000000,
            0x00000000, 0x00000000, 0x00000000, 0x00000000,
        },
    },
    {
        .org_data_off = 507 * 8 * 4,
        .new_data_sz = 64,
        .data = {
            0x808a1940, 0xc608e011, 0x380bf856, 0x582b552a,
            0x432e7908, 0xf762f86b, 0xf76a937e, 0x80000000,
            0x00000000, 0x00000000, 0x00000000, 0x00000000,
            0x00000000, 0x00000000, 0x00000000, 0x00000000,
        },
    },
    {
        .org_data_off = 523 * 8 * 4,
        .new_data_sz = 64,
        .data = {
            0xc0649afa, 0xe5d8c008, 0x9406482c, 0x0210bef2,
            0x05260e82, 0xa3b0a1c5, 0x3c293fe5, 0x80000000,
            0x00000000, 0x00000000, 0x00000000, 0x00000000,
            0x00000000, 0x00000000, 0x00000000, 0x00000000,
        },
    },
    {
        .org_data_off = 539 * 8 * 4,
        .new_data_sz = 64,
        .data = {
            0x20006000, 0x0c000800, 0x01000400, 0x00800180,
            0x00300020, 0x00040010, 0x80020006, 0x80000000,
    ...
    {
        .org_data_off = 668 * 8 * 4,
        .new_data_sz = 64,
        .data = {
            0x01a9961d, 0x372f0054, 0xa030e8f2, 0x74588d60,
            0x63f6e617, 0x6c067a53, 0x3ca32777, 0x80000001,
            0x00000000, 0x00000000, 0x00000000, 0x00000000,
            0x00000000, 0x00000000, 0x00000000, 0x00000000,
        },
    },
    {
        .org_data_off = 684 * 8 * 4,
        .new_data_sz = 64,
        .data = {
            0xc0869232, 0x75774018, 0xa4178872, 0xc93e1d38,
            0xa1f3378f, 0x1bf4bfcf, 0xf8feb4df, 0x80000000,
            0x00000000, 0x00000000, 0x00000000, 0x00000000,
            0x00000000, 0x00000000, 0x00000000, 0x00000000,
        },
    },
    {
        .org_data_off = 700 * 8 * 4,
        .new_data_sz = 64,
        .data = {
            0x803a117d, 0x564ee005, 0x38062829, 0xe22e7d18,
            0xefabdf0d, 0x62920009, 0x92a1e0c6, 0x80000000,
            0x00000000, 0x00000000, 0x00000000, 0x00000000,
            0x00000000, 0x00000000, 0x00000000, 0x00000000,
        },
    },
    {
        .org_data_off = 716 * 8 * 4,
        .new_data_sz = 64,
        .data = {
            0x20006000, 0x0c000800, 0x01000400, 0x00800180,
            0x00300020, 0x00040010, 0x80020006, 0x80000000,
    ...
    {
        .org_data_off = 845 * 8 * 4,
        .new_data_sz = 64,
        .data = {
            0x015292b2, 0x46b3602e, 0x8c18e0b5, 0xe4520d5d,
            0x9ff44d12, 0x90058092, 0x14032807, 0x80000001,
            0x00000000, 0x00000000, 0x00000000, 0x00000000,
            0x00000000, 0x00000000, 0x00000000, 0x00000000,
        },
    },
    {
        .org_data_off = 861 * 8 * 4,
        .new_data_sz = 64,
        .data = {
            0x80fb8f5a, 0x26616026, 0xc81a80a0, 0xe350ed50,
            0x27f59c12, 0xc474c0d2, 0xe9766d7e, 0x80000000,
            0x00000000, 0x00000000, 0x00000000, 0x00000000,
            0x00000000, 0x00000000, 0x00000000, 0x00000000,
        },
    },
    {
        .org_data_off = 877 * 8 * 4,
        .new_data_sz = 64,
        .data = {
            0xc0f59478, 0xd7b82015, 0x28150063, 0xc647af5c,
            0x00300012, 0xd174aab0, 0xba31d17d, 0x80000000,
            0x00000000, 0x00000000, 0x00000000, 0x00000000,
            0x00000000, 0x00000000, 0x00000000, 0x00000000,
        },
    },
    {
        .org_data_off = 893 * 8 * 4,
        .new_data_sz = 64,
        .data = {
            0x20006000, 0x0c000800, 0x01000400, 0x00800180,
            0x00300020, 0x00040010, 0x80020006, 0x80000000,
...
static MPP_RET hal_av1d_alloc_res(void *hal)
{
    ...
    BUF_CHECK(ret, mpp_buffer_get(p_hal->cfg->buf_group, &reg_ctx->cdf_rd_def_base, MPP_ALIGN(sizeof(g_av1d_default_prob), 2048)));
    ...
    /* update vdpu384b def cdf */
    {
        RK_U8 *src, *dst;

        for (i = 0; i < VDPU384B_DEF_CDF_UPDATE_ARRAY_SIZE; i++) {
            src = (RK_U8 *)vdpu384b_def_prob_update_info[i].data;
            dst = (RK_U8 *)cdf_ptr;
            dst += vdpu384b_def_prob_update_info[i].org_data_off;
            memcpy(dst, src, vdpu384b_def_prob_update_info[i].new_data_sz);
        }
    }
...
MPP_DEC_HAL_API_REGISTER(hal_av1d_vdpu384b)
