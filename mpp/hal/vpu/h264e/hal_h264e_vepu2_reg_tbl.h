...
#ifndef HAL_H264E_VEPU2_REG_TBL_H
#define HAL_H264E_VEPU2_REG_TBL_H
...
#define     VEPU_REG_AXI_CTRL_BIRST_DISABLE     MPP_BIT(0)
...
#define     VEPU_REG_DISABLE_QUARTER_PIXEL_MV       MPP_BIT(28)
#define     VEPU_REG_DEBLOCKING_FILTER_MODE(x)      (((x) & 0x3) << 24)
#define     VEPU_REG_CABAC_INIT_IDC(x)          (((x) & 0x3) << 21)
#define     VEPU_REG_ENTROPY_CODING_MODE        MPP_BIT(20)
#define     VEPU_REG_H264_TRANS8X8_MODE         MPP_BIT(17)
#define     VEPU_REG_H264_INTER4X4_MODE         MPP_BIT(16)
#define     VEPU_REG_H264_STREAM_MODE           MPP_BIT(15)
...
#define     VEPU_REG_VP8_SEGMENT_MAP_UPDATE     MPP_BIT(30)
#define     VEPU_REG_VP8_SEGMENT_EN         MPP_BIT(29)
#define     VEPU_REG_VP8_MV_REF_IDX2_EN         MPP_BIT(28)
...
#define     VEPU_REG_SIZE_TABLE_PRESENT         MPP_BIT(0)
...
#define     VEPU_REG_FILTER_DISABLE         MPP_BIT(5)
...
#define     VEPU_REG_SPLIT_MV_MODE_EN           MPP_BIT(0)
...
#define     VEPU_REG_MVC_ANCHOR_PIC_FLAG        MPP_BIT(7)
#define     VEPU_REG_MVC_PRIORITY_ID(x)         (((x) & 0x7) << 4)
#define     VEPU_REG_MVC_TEMPORAL_ID(x)         (((x) & 0x7) << 1)
#define     VEPU_REG_MVC_INTER_VIEW_FLAG        MPP_BIT(0)
...
#define     VEPU_REG_INPUT_SWAP8            MPP_BIT(31)
#define     VEPU_REG_INPUT_SWAP8_(x)         (((x) & 1) << 31)
#define     VEPU_REG_INPUT_SWAP16           MPP_BIT(30)
#define     VEPU_REG_INPUT_SWAP16_(x)        (((x) & 1) << 30)
#define     VEPU_REG_INPUT_SWAP32           MPP_BIT(29)
#define     VEPU_REG_INPUT_SWAP32_(x)        (((x) & 1) << 29)
#define     VEPU_REG_OUTPUT_SWAP8           MPP_BIT(28)
#define     VEPU_REG_OUTPUT_SWAP16          MPP_BIT(27)
#define     VEPU_REG_OUTPUT_SWAP32          MPP_BIT(26)
#define     VEPU_REG_TEST_IRQ               MPP_BIT(24)
#define     VEPU_REG_TEST_COUNTER(x)            (((x) & 0xf) << 20)
#define     VEPU_REG_TEST_REG               MPP_BIT(19)
#define     VEPU_REG_TEST_MEMORY            MPP_BIT(18)
...
#define     VEPU_REG_INTERRUPT_NON          MPP_BIT(28)
#define     VEPU_REG_MV_WRITE_EN            MPP_BIT(24)
#define     VEPU_REG_RECON_WRITE_DIS            MPP_BIT(20)
#define     VEPU_REG_INTERRUPT_SLICE_READY_EN       MPP_BIT(16)
#define     VEPU_REG_CLK_GATING_EN          MPP_BIT(12)
#define     VEPU_REG_INTERRUPT_TIMEOUT_EN       MPP_BIT(10)
#define     VEPU_REG_INTERRUPT_RESET            MPP_BIT(9)
#define     VEPU_REG_INTERRUPT_DIS_BIT          MPP_BIT(8)
#define     VEPU_REG_INTERRUPT_TIMEOUT          MPP_BIT(6)
#define     VEPU_REG_INTERRUPT_BUFFER_FULL      MPP_BIT(5)
#define     VEPU_REG_INTERRUPT_BUS_ERROR        MPP_BIT(4)
#define     VEPU_REG_INTERRUPT_FUSE         MPP_BIT(3)
#define     VEPU_REG_INTERRUPT_SLICE_READY      MPP_BIT(2)
#define     VEPU_REG_INTERRUPT_FRAME_READY      MPP_BIT(1)
...
#define     VDPU_REG_CONFIG_TILED_MODE_LSB      MPP_BIT(12)
#define     VDPU_REG_CONFIG_DEC_ADV_PRE_DIS     MPP_BIT(11)
#define     VDPU_REG_CONFIG_DEC_SCMD_DIS        MPP_BIT(10)
#define     VDPU_REG_DEC_CTRL0_SKIP_MODE        MPP_BIT(9)
#define     VDPU_REG_DEC_CTRL0_FILTERING_DIS        MPP_BIT(8)
#define     VDPU_REG_DEC_CTRL0_PIC_FIXED_QUANT      MPP_BIT(7)
#define     VDPU_REG_CONFIG_DEC_LATENCY(x)      (((x) & 0x3f) << 1)
#define     VDPU_REG_CONFIG_TILED_MODE_MSB(x)       MPP_BIT(0)
#define     VDPU_REG_CONFIG_DEC_OUT_TILED_E     MPP_BIT(0)
#define VDPU_REG_STREAM_LEN         0x0cc
#define     VDPU_REG_DEC_CTRL3_INIT_QP(x)       (((x) & 0x3f) << 25)
#define     VDPU_REG_DEC_STREAM_LEN_HI          MPP_BIT(24)
...
#define     VDPU_REG_CONFIG_DEC_STRENDIAN_E     MPP_BIT(5)
#define     VDPU_REG_CONFIG_DEC_STRSWAP32_E     MPP_BIT(4)
#define     VDPU_REG_CONFIG_DEC_OUTSWAP32_E     MPP_BIT(3)
#define     VDPU_REG_CONFIG_DEC_INSWAP32_E      MPP_BIT(2)
#define     VDPU_REG_CONFIG_DEC_OUT_ENDIAN      MPP_BIT(1)
#define     VDPU_REG_CONFIG_DEC_IN_ENDIAN       MPP_BIT(0)
#define VDPU_REG_INTERRUPT          0x0dc
#define     VDPU_REG_INTERRUPT_DEC_TIMEOUT      MPP_BIT(13)
#define     VDPU_REG_INTERRUPT_DEC_ERROR_INT        MPP_BIT(12)
#define     VDPU_REG_INTERRUPT_DEC_PIC_INF      MPP_BIT(10)
#define     VDPU_REG_INTERRUPT_DEC_SLICE_INT        MPP_BIT(9)
#define     VDPU_REG_INTERRUPT_DEC_ASO_INT      MPP_BIT(8)
#define     VDPU_REG_INTERRUPT_DEC_BUFFER_INT       MPP_BIT(6)
#define     VDPU_REG_INTERRUPT_DEC_BUS_INT      MPP_BIT(5)
#define     VDPU_REG_INTERRUPT_DEC_RDY_INT      MPP_BIT(4)
#define     VDPU_REG_INTERRUPT_DEC_IRQ_DIS      MPP_BIT(1)
#define     VDPU_REG_INTERRUPT_DEC_IRQ          MPP_BIT(0)
#define VDPU_REG_AXI_CTRL           0x0e0
#define     VDPU_REG_AXI_DEC_SEL            MPP_BIT(23)
#define     VDPU_REG_CONFIG_DEC_DATA_DISC_E     MPP_BIT(22)
#define     VDPU_REG_PARAL_BUS_E(x)         MPP_BIT(21)
...
#define     VDPU_REG_AHB_HLOCK_E            MPP_BIT(31)
#define     VDPU_REG_CACHE_E                MPP_BIT(29)
#define     VDPU_REG_PREFETCH_SINGLE_CHANNEL_E      MPP_BIT(28)
#define     VDPU_REG_INTRA_3_CYCLE_ENHANCE      MPP_BIT(27)
#define     VDPU_REG_INTRA_DOUBLE_SPEED         MPP_BIT(26)
#define     VDPU_REG_INTER_DOUBLE_SPEED         MPP_BIT(25)
#define     VDPU_REG_DEC_CTRL3_START_CODE_E     MPP_BIT(22)
#define     VDPU_REG_DEC_CTRL3_CH_8PIX_ILEAV_E      MPP_BIT(21)
#define     VDPU_REG_DEC_CTRL0_RLC_MODE_E       MPP_BIT(20)
#define     VDPU_REG_DEC_CTRL0_DIVX3_E          MPP_BIT(19)
#define     VDPU_REG_DEC_CTRL0_PJPEG_E          MPP_BIT(18)
#define     VDPU_REG_DEC_CTRL0_PIC_INTERLACE_E      MPP_BIT(17)
#define     VDPU_REG_DEC_CTRL0_PIC_FIELDMODE_E      MPP_BIT(16)
#define     VDPU_REG_DEC_CTRL0_PIC_B_E          MPP_BIT(15)
#define     VDPU_REG_DEC_CTRL0_PIC_INTER_E      MPP_BIT(14)
#define     VDPU_REG_DEC_CTRL0_PIC_TOPFIELD_E       MPP_BIT(13)
#define     VDPU_REG_DEC_CTRL0_FWD_INTERLACE_E      MPP_BIT(12)
#define     VDPU_REG_DEC_CTRL0_SORENSON_E       MPP_BIT(11)
#define     VDPU_REG_DEC_CTRL0_WRITE_MVS_E      MPP_BIT(10)
#define     VDPU_REG_DEC_CTRL0_REF_TOPFIELD_E       MPP_BIT(9)
#define     VDPU_REG_DEC_CTRL0_REFTOPFIRST_E        MPP_BIT(8)
#define     VDPU_REG_DEC_CTRL0_SEQ_MBAFF_E      MPP_BIT(7)
#define     VDPU_REG_DEC_CTRL0_PICORD_COUNT_E       MPP_BIT(6)
#define     VDPU_REG_CONFIG_DEC_TIMEOUT_E       MPP_BIT(5)
#define     VDPU_REG_CONFIG_DEC_CLK_GATE_E      MPP_BIT(4)
#define     VDPU_REG_DEC_CTRL0_DEC_OUT_DIS      MPP_BIT(2)
#define     VDPU_REG_REF_BUF_CTRL2_REFBU2_BUF_E     MPP_BIT(1)
#define     VDPU_REG_INTERRUPT_DEC_E            MPP_BIT(0)
...
#define     VDPU_REG_ADDR_REF_FIELD_E           MPP_BIT(1)
#define     VDPU_REG_ADDR_REF_TOPC_E            MPP_BIT(0)
...
#define     VDPU_REG_DEC_CTRL5_FILT_CTRL_PRES       MPP_BIT(31)
#define     VDPU_REG_DEC_CTRL5_RDPIC_CNT_PRES       MPP_BIT(30)
...
#define     VDPU_REG_DEC_CTRL5_IDR_PIC_E        MPP_BIT(8)
#define     VDPU_REG_DEC_CTRL4_DIR_8X8_INFER_E      MPP_BIT(7)
#define     VDPU_REG_DEC_CTRL4_BLACKWHITE_E     MPP_BIT(6)
#define     VDPU_REG_DEC_CTRL4_CABAC_E          MPP_BIT(5)
#define     VDPU_REG_DEC_CTRL4_WEIGHT_PRED_E        MPP_BIT(4)
#define     VDPU_REG_DEC_CTRL5_CONST_INTRA_E        MPP_BIT(3)
#define     VDPU_REG_DEC_CTRL5_8X8TRANS_FLAG_E      MPP_BIT(2)
#define     VDPU_REG_DEC_CTRL2_TYPE1_QUANT_E        MPP_BIT(1)
#define     VDPU_REG_DEC_CTRL2_FIELDPIC_FLAG_E      MPP_BIT(0)
...
#define     VDPU_REG_DEC_CTRL4_VC1_HEIGHT_EXT       MPP_BIT(13)
#define     VDPU_REG_DEC_CTRL4_BILIN_MC_E       MPP_BIT(12)
...
#define     VDPU_REG_REF_PIC_FILT_TYPE_E        MPP_BIT(31)
...
#define     VDPU_REG_VP8_GREF_SIGN_BIAS         MPP_BIT(0)
#define     VDPU_REG_VP8_AREF_SIGN_BIAS         MPP_BIT(0)
...
#define     VDPU_REG_FWD_PIC1_SEGMENT_UPD_E     MPP_BIT(1)
#define     VDPU_REG_FWD_PIC1_SEGMENT_E         MPP_BIT(0)
