...
const RK_U32 h264_prev_mode_favor[52] = {
...
/* sqrt(2^((qp-12)/3))*8 */
const RK_U32 h264_diff_mv_penalty[52] = {
    2,   2,   3,   3,   3,   4,   4,   4,   5,   6,
...
/* 31*sqrt(2^((qp-12)/3))/4 */
const RK_U32 h264_diff_mv_penalty4p[52] = {
    2, 2, 2, 3, 3, 3, 4, 4, 5, 5,
...
const RK_U32 h264_intra16_favor[52] = {
...
const RK_U32 h264_inter_favor[52] = {
    0, 0, 0, 0, 0, 0, 45, 48, 51, 53, 55, 60, 62, 67, 69, 72,
...
const RK_U32 h264_skip_sad_penalty[52] = {
