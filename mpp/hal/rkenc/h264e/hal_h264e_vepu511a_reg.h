...
#ifndef HAL_H264E_VEPU511A_REG_H
#define HAL_H264E_VEPU511A_REG_H
...
typedef struct H264eVepu511aFrame_t {
...
typedef struct H264eVepu511aParam_t {
    /* 0x00001700 reg1472 */
    struct {
...
typedef struct H264eVepu511aSqiCfg_t {
    /* 0x00002000 reg2048 */
    struct {
        RK_U32 reserved1             : 12;
    ...
    /* 0x00002004 reg2049 - 0x00002010 reg2052*/
    RK_U32 reserved_2049_2052[4];
    ...
    /* 0x000020bc reg2095 - 0x000020cc reg2099*/
    RK_U32 reserved_2095_2099[5];

    /* 0x20D0 CMPLX_STATC_CFG_COMB */
    struct {
    ...
    /* 0x000020d4 reg2101*/
    RK_U32 reserved_2101;

    /* 0x20D8 CMPLX_STATC_THD1_COMB reg2102*/
    struct {
        ...
        RK_U32 reserved1                           : 1;
    } cmplx_statc_thd1_comb;

    /* 0x20DC CMPLX_STATC_THD2_COMB reg2103*/
    struct {
        ...
        RK_U32 reserved1                              : 2;
    } cmplx_statc_thd2_comb;

    /* 0x20E0 CMPLX_STATC_WGT0_COMB reg2104*/
    struct {
    ...
    } cmplx_statc_wgt0_comb;

    /* 0x20E4 CMPLX_STATC_WGT1_COMB reg2105*/
    struct {
...
typedef struct H264eVepu511aSclCfg_t {
...
typedef struct HalVepu511aReg_t {
    Vepu511aControlCfg       reg_ctl;
    H264eVepu511aFrame       reg_frm;
    Vepu511aRcRoi            reg_rc_roi;
    H264eVepu511aParam       reg_param;
    H264eVepu511aSqi         reg_sqi;
    H264eVepu511aSclCfg      reg_scl;
    Vepu511aStatus           reg_st;
    Vepu511aDbg              reg_dbg;
} HalVepu511aRegSet;
