...
#ifndef HAL_H265E_VEPU511A_REG_H
#define HAL_H265E_VEPU511A_REG_H
...
typedef struct H265eVepu511aFrame_t {
    /* 0x00000270 reg156  - 0x0000039c reg231 */
    Vepu511aFrmCommon common;
    ...
    struct {
        ...
        RK_U32 ltm_idx0l0                             : 1;
        RK_U32 reserved1                              : 1;
        RK_U32 pu8_inter_interpolation_num_big_lvl    : 3;
        RK_U32 pu16_inter_interpolation_num_big_lvl   : 3;
        RK_U32 pu32_inter_interpolation_num_big_lvl   : 3;
        RK_U32 pu64_inter_interpolation_num_big_lvl   : 3;
        RK_U32 reserved2                              : 1;
    ...
    struct {
        RK_U32 pu32_intra_mode_num_big_lvl              : 2;
        RK_U32 pu16_intra_mode_num_big_lvl              : 2;
        RK_U32 pu8_intra_mode_num_big_lvl               : 2;
        RK_U32 pu4_intra_mode_num                       : 2;
        RK_U32 pu32_intra_mode_num_small_lvl            : 2;
        RK_U32 pu16_intra_mode_num_small_lvl            : 2;
        RK_U32 pu8_intra_mode_num_small_lvl             : 2;
        RK_U32 reserved1                                : 2;
        RK_U32 pu8_inter_interpolation_num_small_lvl    : 3;
        RK_U32 pu16_inter_interpolation_num_small_lvl   : 3;
        RK_U32 pu32_inter_interpolation_num_small_lvl   : 3;
        RK_U32 pu64_inter_interpolation_num_small_lvl   : 3;
        RK_U32 reserved2                                : 4;
    } rdo_intra_mode;
    ...
    /* 0x400 reg256 - 0x51c reg327*/
    RK_U32 reserved256_327[72];
...
typedef struct H265eVepu511aParam_t {
    ...
    /* 0x1748 reg1490 */
    struct {
        RK_U32 light_change_zero_mv_j_coef   : 5;
        RK_U32 reserved1                     : 27;
    } light_wgt_hevc;

    /* 0x174c - 0x175c */
    RK_U32 reserved1491_1495[5];
...
typedef struct H265eVepu511aSqiCfg_t {
    /* 0x00002000 reg2048 */
    struct {
...
typedef struct H265eVepu511aSclCfg_t {
...
typedef struct H265eV511ARegSet_t {
    Vepu511aControlCfg         reg_ctl;
    H265eVepu511aFrame         reg_frm;
    Vepu511aRcRoi              reg_rc_roi;
    H265eVepu511aParam         reg_param;
    H265eVepu511aSqi           reg_sqi;
    H265eVepu511aSclCfg        reg_scl;
    Vepu511aDbg                reg_dbg;
} H265eV511ARegSet;
