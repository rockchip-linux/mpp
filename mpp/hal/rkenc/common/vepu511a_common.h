...
#define VEPU511A_RC_ROI_OFFSET        (1024 * sizeof(RK_U32))    /* 0x00001000 reg1024 - 0x00001160 reg1112 */
#define VEPU511A_PARAM_OFFSET         (1472 * sizeof(RK_U32))    /* 0x00001700 reg1472 - 0x000019cc reg1651 */
#define VEPU511A_SQI_OFFSET           (2048 * sizeof(RK_U32))    /* 0x00002000 reg2048 - 0x0000216c reg2139 */
#define VEPU511A_SCL_OFFSET           (2176 * sizeof(RK_U32))    /* 0x00002200 reg2176 - 0x00002c9c reg2855 */
#define VEPU511A_SLI_OFFSET           (2951 * sizeof(RK_U32))    /* 0x00002e20 reg2951 - 0x00002e40 reg2959 */
#define VEPU511A_STATUS_OFFSET        (4096 * sizeof(RK_U32))    /* 0x00004000 reg4096 - 0x0000424c reg4243 */
#define VEPU511A_DBG_OFFSET           (5120 * sizeof(RK_U32))    /* 0x00005000 reg5120 - 0x0000523c reg5263 */
#define VEPU511A_REG_BASE_HW_STATUS   (0x2c)
...
typedef struct Vepu511aRoiRegion_t {
    struct {
        RK_U32 roi_lt_x    : 10;
        RK_U32 reserved    : 6;
        RK_U32 roi_lt_y    : 10;
...
typedef struct Vepu511aRoiCfg_t {
    /* 0x00001080 reg1056 */
    union {
        struct {
    ...
    Vepu511aRoiRegion regions[8];
} Vepu511aRoiCfg;

/* class: control/link */
/* 0x00000000 reg0 - 0x00000120 reg72 */
typedef struct Vepu511aControlCfg_t {
    /* 0x00000000 reg0 */
    struct {
        RK_U32 sub_ver      : 8;
        RK_U32 h264_cap     : 1;
...
typedef struct Vepu511aFrmCommon_t {
    /* 0x00000270 reg156 - 0x0000027c reg159 */
    vepu511a_online online_addr;
...
typedef struct Vepu511aPpFrameCfg_t {
    /* 0x00000520 reg328 */
    RK_U32 adr_md_vpp;
...
typedef struct Vepu511aRcRoi_t {
    /* 0x00001000 reg1024 */
    struct {
        RK_U32 qp_adj0     : 5;
        RK_U32 qp_adj1     : 5;
...
typedef struct Vepu511aSli_t {
    /* 0x2E20 ENT_SLI_ADD_DAT0 */
    struct {
        RK_U32 before_every_slice_add_data0   : 32;
    } ent_sli_add_dat0;

    /* 0x2E24 ENT_SLI_ADD_DAT1 */
    struct {
        RK_U32 before_every_slice_add_data1   : 32;
    } ent_sli_add_dat1;

    /* 0x2E28 ENT_SLI_ADD_DAT2 */
    struct {
        RK_U32 before_every_slice_add_data2   : 32;
    } ent_sli_add_dat2;

    /* 0x2E2C ENT_SLI_ADD_DAT3 */
    struct {
        RK_U32 before_every_slice_add_data3   : 32;
    } ent_sli_add_dat3;

    /* 0x2E30 ENT_SLI_ADD_DAT4 */
    struct {
        RK_U32 after_frame_add_data0   : 32;
    } ent_sli_add_dat4;

    /* 0x2E34 ENT_SLI_ADD_DAT5 */
    struct {
        RK_U32 after_frame_add_data1   : 32;
    } ent_sli_add_dat5;

    /* 0x2E38 ENT_SLI_ADD_DAT6 */
    struct {
        RK_U32 after_frame_add_data2   : 32;
    } ent_sli_add_dat6;

    /* 0x2E3C ENT_SLI_ADD_DAT7 */
    struct {
        RK_U32 after_frame_add_data3   : 32;
    } ent_sli_add_dat7;

    /* 0x2E40 ENT_SLI_ADD_BYTE */
    struct {
        RK_U32 before_every_slice_add_byte_len   : 5;
        RK_U32 after_frame_add_byte_len          : 5;
        RK_U32 reserved1                         : 22;
    } ent_sli_add_byte;
} Vepu511aSli;
...
typedef struct Vepu511aStatus_t {
    /* 0x00004000 reg4096 */
    RK_U32 bs_lgth_l32;
...
typedef struct Vepu511aH264RoiBlkCfg {
    RK_U32 qp_adju        : 8;
