...
#ifndef MPP_ENC_DEBUG_H
#define MPP_ENC_DEBUG_H
...
#define mpp_enc_dbg(flag, fmt, ...)     mpp_dbg(mpp_enc_debug, flag, fmt, ## __VA_ARGS__)
#define mpp_enc_dbg_f(flag, fmt, ...)   mpp_dbg_f(mpp_enc_debug, flag, fmt, ## __VA_ARGS__)
