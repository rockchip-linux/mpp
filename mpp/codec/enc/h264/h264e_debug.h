...
#define H264E_DBG_FLOW              (0x00000020)
#define H264E_DBG_DETAIL            (0x00000040)

#define H264E_DBG_SPS               (0x00000100)
#define H264E_DBG_PPS               (0x00000200)
#define H264E_DBG_SLICE             (0x00000400)
#define H264E_DBG_SEI               (0x00000800)

#define H264E_DBG_DPB               (0x00001000)
#define H264E_DBG_LIST              (0x00002000)
